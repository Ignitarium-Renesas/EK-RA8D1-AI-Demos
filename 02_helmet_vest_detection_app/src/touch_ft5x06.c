...
{
    memset(&g_touch_data, 0, sizeof(ft5x06_payload_t));
}
...
void test_tp()
{
    ...
    R_IOPORT_PinCfg(&g_ioport_ctrl, DSP_INT_PIN, ((uint32_t)(IOPORT_CFG_IRQ_ENABLE | (uint32_t)IOPORT_CFG_PORT_DIRECTION_INPUT )));
 ...
 **********************************************************************************************************************/
void ft5x06_init(i2c_master_instance_t const * p_i2c_instance, void * i2c_semaphore, bsp_io_port_pin_t reset_pin)
{
