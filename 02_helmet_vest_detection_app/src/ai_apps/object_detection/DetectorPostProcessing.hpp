...
namespace object_detection {
    ...
    private:
        ...
        //e_printf("Size of DetectionResult: %zu bytes\n", sizeof(object_detection::DetectionResult));
        //e_printf("Capacity of m_results: %zu\n", m_results.capacity());
         ...
         **/
        void InsertTopNDetections(std::vector<image::Detection>& detections, image::Detection& det);
