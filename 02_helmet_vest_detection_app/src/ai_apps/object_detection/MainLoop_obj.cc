...
#include "FastestDetModel.hpp"       /* Model class for running inference. */
#include "UseCaseCommonUtils.hpp"     /* Utils functions. */
#include "log_macros.h"
#include "BufAttributes.hpp"        /* Buffer attributes to be applied */
#include "hal_data.h"

extern uint8_t tensorArena[0x00A8000];
...
arm::app::FastestDetModel model_obj;  /* Model wrapper object. */
int model_init_obj = false;
void main_loop_obj()
{
    /* Load the model. */
    if(!model_init_obj)
